...
import { Button } from "@/styles/base-weibo/ui/button"
import { Input } from "@/styles/base-weibo/ui/input"
import { Separator } from "@/styles/base-weibo/ui/separator"
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@/styles/base-weibo/ui/sheet"
import { Skeleton } from "@/styles/base-weibo/ui/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@/styles/base-weibo/ui/tooltip"
...
function SidebarGroupAction({
  ...
  return useRender({
    ...
    props: mergeProps<"button">(
      {
        className: cn(
          "flex aspect-square items-center justify-center outline-hidden transition-transform group-data-[collapsible=icon]:hidden after:absolute after:-inset-2 md:after:hidden [&>svg]:shrink-0",
          className
        ),
      },
      props
