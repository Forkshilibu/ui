...
const buttonVariants = cva(
  "text-c-content focus-visible:border-c-focus focus-visible:shadow-orange-glow disabled:bg-btn-gray-disabled disabled:text-c-content-disabled group/button inline-flex min-h-11 shrink-0 items-center justify-center rounded-full border border-transparent bg-clip-padding text-[length:var(--text-label-lg)] leading-[var(--text-label-lg--line-height)] font-normal whitespace-nowrap transition-all outline-none select-none disabled:pointer-events-none disabled:opacity-100 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default:
          "gap-md-compact px-lg min-h-11 text-[length:var(--text-label-lg)] leading-[var(--text-label-lg--line-height)]",
        xs: "gap-sm px-md min-h-8 text-[length:var(--text-label-sm)] leading-[var(--text-label-sm--line-height)] [&_svg:not([class*='size-'])]:size-3",
        sm: "gap-sm px-md min-h-9 text-[length:var(--text-label-md)] leading-[var(--text-label-md--line-height)] [&_svg:not([class*='size-'])]:size-3.5",
        lg: "gap-md-compact px-xl min-h-12 text-[length:var(--text-label-lg)] leading-[var(--text-label-lg--line-height)]",
