...
<ComponentPreview styleName="radix-weibo" name="field-input" />

### Textarea

<ComponentPreview styleName="radix-weibo" name="field-textarea" />

### Select

<ComponentPreview styleName="radix-weibo" name="field-select" />

### Slider

<ComponentPreview styleName="radix-weibo" name="field-slider" />

### Fieldset

<ComponentPreview styleName="radix-weibo" name="field-fieldset" />
...
<ComponentPreview styleName="radix-weibo" name="field-radio" />

### Switch

<ComponentPreview styleName="radix-weibo" name="field-switch" />

### Choice Card

Wrap `Field` components inside `FieldLabel` to create selectable field groups. This works with `RadioItem`, `Checkbox` and `Switch` components.

<ComponentPreview styleName="radix-weibo" name="field-choice-card" />
