...
<ComponentPreview styleName="radix-weibo" name="command-basic" />

### Shortcuts

<ComponentPreview styleName="radix-weibo" name="command-shortcuts" />

### Groups

A command menu with groups, icons and separators.

<ComponentPreview styleName="radix-weibo" name="command-groups" />

### Scrollable

Scrollable command menu with multiple items.

<ComponentPreview styleName="radix-weibo" name="command-scrollable" />
