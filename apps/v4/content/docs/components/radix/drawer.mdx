...
<ComponentPreview styleName="radix-weibo" name="drawer-demo" />
...
<ComponentPreview styleName="radix-weibo" name="drawer-scrollable-content" />

### Sides

Use the `direction` prop to set the side of the drawer. Available options are `top`, `right`, `bottom`, and `left`.

<ComponentPreview styleName="radix-weibo" name="drawer-sides" />

### Responsive Dialog

You can combine the `Dialog` and `Drawer` components to create a responsive dialog. This renders a `Dialog` component on desktop and a `Drawer` on mobile.

<ComponentPreview styleName="radix-weibo" name="drawer-dialog" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="radix-weibo" name="drawer-rtl" direction="rtl" />
