...
<ComponentPreview styleName="radix-weibo" name="popover-demo" />
...
<ComponentPreview styleName="radix-weibo" name="popover-basic" />

### Align

Use the `align` prop on `PopoverContent` to control the horizontal alignment.

<ComponentPreview styleName="radix-weibo" name="popover-alignments" />

### With Form

A popover with form fields inside.

<ComponentPreview styleName="radix-weibo" name="popover-form" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="radix-weibo" name="popover-rtl" direction="rtl" />
