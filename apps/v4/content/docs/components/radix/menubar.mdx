...
<ComponentPreview styleName="radix-weibo" name="menubar-demo" />
...
<ComponentPreview styleName="radix-weibo" name="menubar-checkbox" />

### Radio

Use `MenubarRadioGroup` and `MenubarRadioItem` for single-select options.

<ComponentPreview styleName="radix-weibo" name="menubar-radio" />

### Submenu

Use `MenubarSub`, `MenubarSubTrigger`, and `MenubarSubContent` for nested menus.

<ComponentPreview styleName="radix-weibo" name="menubar-submenu" />

### With Icons

<ComponentPreview styleName="radix-weibo" name="menubar-icons" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="radix-weibo" name="menubar-rtl" direction="rtl" />
