...
<ComponentPreview styleName="radix-weibo" name="sheet-demo" />
...
<ComponentPreview styleName="radix-weibo" name="sheet-side" />

### No Close Button

Use `showCloseButton={false}` on `SheetContent` to hide the close button.

<ComponentPreview styleName="radix-weibo" name="sheet-no-close-button" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="radix-weibo" name="sheet-rtl" direction="rtl" />
