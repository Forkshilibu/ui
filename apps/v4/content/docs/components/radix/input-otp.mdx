...
<ComponentPreview styleName="radix-weibo" name="input-otp-demo" />
...
<ComponentPreview styleName="radix-weibo" name="input-otp-pattern" />
...
<ComponentPreview styleName="radix-weibo" name="input-otp-separator" />

### Disabled

Use the `disabled` prop to disable the input.

<ComponentPreview styleName="radix-weibo" name="input-otp-disabled" />

### Controlled

Use the `value` and `onChange` props to control the input value.

<ComponentPreview styleName="radix-weibo" name="input-otp-controlled" />

### Invalid

Use `aria-invalid` on the slots to show an error state.

<ComponentPreview styleName="radix-weibo" name="input-otp-invalid" />

### Four Digits

A common pattern for PIN codes. This uses the `pattern={REGEXP_ONLY_DIGITS}` prop.

<ComponentPreview styleName="radix-weibo" name="input-otp-four-digits" />

### Alphanumeric

Use `REGEXP_ONLY_DIGITS_AND_CHARS` to accept both letters and numbers.

<ComponentPreview styleName="radix-weibo" name="input-otp-alphanumeric" />
