...
<ComponentPreview styleName="radix-weibo" name="separator-demo" />
...
<ComponentPreview styleName="radix-weibo" name="separator-vertical" />

### Menu

Vertical separators between menu items with descriptions.

<ComponentPreview styleName="radix-weibo" name="separator-menu" />

### List

Horizontal separators between list items.

<ComponentPreview styleName="radix-weibo" name="separator-list" />
