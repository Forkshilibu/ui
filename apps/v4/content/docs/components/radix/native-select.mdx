...
<ComponentPreview styleName="radix-weibo" name="native-select-demo" />
...
<ComponentPreview styleName="radix-weibo" name="native-select-groups" />

### Disabled

Add the `disabled` prop to the `NativeSelect` component to disable the select.

<ComponentPreview styleName="radix-weibo" name="native-select-disabled" />

### Invalid

Use `aria-invalid` to show validation errors and the `data-invalid` attribute to the `Field` component for styling.

<ComponentPreview styleName="radix-weibo" name="native-select-invalid" />
