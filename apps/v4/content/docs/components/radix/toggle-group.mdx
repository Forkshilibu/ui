...
<ComponentPreview styleName="radix-weibo" name="toggle-group-demo" />
...
<ComponentPreview styleName="radix-weibo" name="toggle-group-outline" />

### Size

Use the `size` prop to change the size of the toggle group.

<ComponentPreview styleName="radix-weibo" name="toggle-group-sizes" />

### Spacing

Use `spacing` to add spacing between toggle group items.

<ComponentPreview styleName="radix-weibo" name="toggle-group-spacing" />

### Vertical

Use `orientation="vertical"` for vertical toggle groups.

<ComponentPreview styleName="radix-weibo" name="toggle-group-vertical" />

### Disabled

<ComponentPreview styleName="radix-weibo" name="toggle-group-disabled" />
