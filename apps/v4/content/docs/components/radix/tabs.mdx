...
<ComponentPreview styleName="radix-weibo" name="tabs-line" />

### Vertical

Use `orientation="vertical"` for vertical tabs.

<ComponentPreview styleName="radix-weibo" name="tabs-vertical" />

### Disabled

<ComponentPreview styleName="radix-weibo" name="tabs-disabled" />

### Icons

<ComponentPreview styleName="radix-weibo" name="tabs-icons" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="radix-weibo" name="tabs-rtl" direction="rtl" />
