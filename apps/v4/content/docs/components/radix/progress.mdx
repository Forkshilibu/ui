...
<ComponentPreview styleName="radix-weibo" name="progress-demo" />
...
<ComponentPreview styleName="radix-weibo" name="progress-label" />

### Controlled

A progress bar that can be controlled by a slider.

<ComponentPreview styleName="radix-weibo" name="progress-controlled" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="radix-weibo" name="progress-rtl" direction="rtl" />
