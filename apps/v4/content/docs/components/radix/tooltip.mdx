...
<ComponentPreview styleName="radix-weibo" name="tooltip-demo" />
...
<ComponentPreview styleName="radix-weibo" name="tooltip-sides" />

### With Keyboard Shortcut

<ComponentPreview styleName="radix-weibo" name="tooltip-keyboard" />

### Disabled Button

Show a tooltip on a disabled button by wrapping it with a span.

<ComponentPreview styleName="radix-weibo" name="tooltip-disabled" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="radix-weibo" name="tooltip-rtl" direction="rtl" />
