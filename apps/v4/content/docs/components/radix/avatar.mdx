...
<ComponentPreview styleName="radix-weibo" name="avatar-demo" />
...
<ComponentPreview styleName="radix-weibo" name="avatar-basic" />

### Badge

Use the `AvatarBadge` component to add a badge to the avatar. The badge is positioned at the bottom right of the avatar.

<ComponentPreview styleName="radix-weibo" name="avatar-badge" />
...
<ComponentPreview styleName="radix-weibo" name="avatar-dropdown" />
