...
<ComponentPreview styleName="radix-weibo" name="checkbox-invalid" />
...
<ComponentPreview styleName="radix-weibo" name="checkbox-basic" />

### Description

Use `FieldContent` and `FieldDescription` for helper text.

<ComponentPreview styleName="radix-weibo" name="checkbox-description" />

### Disabled

Use the `disabled` prop to prevent interaction and add the `data-disabled` attribute to the `<Field>` component for disabled styles.

<ComponentPreview styleName="radix-weibo" name="checkbox-disabled" />

### Group

Use multiple fields to create a checkbox list.

<ComponentPreview styleName="radix-weibo" name="checkbox-group" />
