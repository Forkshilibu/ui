...
<ComponentPreview styleName="base-weibo" name="progress-demo" />
...
<ComponentPreview styleName="base-weibo" name="progress-label" />

### Controlled

A progress bar that can be controlled by a slider.

<ComponentPreview styleName="base-weibo" name="progress-controlled" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-weibo" name="progress-rtl" direction="rtl" />
