...
<ComponentPreview styleName="base-weibo" name="switch-demo" />
...
<ComponentPreview styleName="base-weibo" name="switch-description" />

### Choice Card

Card-style selection where `FieldLabel` wraps the entire `Field` for a clickable card pattern.

<ComponentPreview styleName="base-weibo" name="switch-choice-card" />
...
<ComponentPreview styleName="base-weibo" name="switch-disabled" />
...
<ComponentPreview styleName="base-weibo" name="switch-invalid" />

### Size

Use the `size` prop to change the size of the switch.

<ComponentPreview styleName="base-weibo" name="switch-sizes" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-weibo" name="switch-rtl" direction="rtl" />
