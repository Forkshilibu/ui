...
<ComponentPreview styleName="base-weibo" name="breadcrumb-basic" />

### Custom separator

Use a custom component as `children` for `<BreadcrumbSeparator />` to create a custom separator.

<ComponentPreview styleName="base-weibo" name="breadcrumb-separator" />

### Dropdown

You can compose `<BreadcrumbItem />` with a `<DropdownMenu />` to create a dropdown in the breadcrumb.

<ComponentPreview styleName="base-weibo" name="breadcrumb-dropdown" />
...
<ComponentPreview styleName="base-weibo" name="breadcrumb-link" />
