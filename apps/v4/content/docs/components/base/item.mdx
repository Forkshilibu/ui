...
<ComponentPreview styleName="base-weibo" name="item-demo" />
...
<ComponentPreview styleName="base-weibo" name="item-icon" />

### Avatar

You can use `ItemMedia` with `variant="avatar"` to display an avatar.

<ComponentPreview styleName="base-weibo" name="item-avatar" />

### Image

Use `ItemMedia` with `variant="image"` to display an image.

<ComponentPreview styleName="base-weibo" name="item-image" />
...
<ComponentPreview styleName="base-weibo" name="item-link" />
...
<ComponentPreview styleName="base-weibo" name="item-dropdown" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-weibo" name="item-rtl" direction="rtl" />
