...
<ComponentPreview styleName="base-weibo" name="pagination-demo" />
...
<ComponentPreview styleName="base-weibo" name="pagination-simple" />

### Icons Only

Use just the previous and next buttons without page numbers. This is useful for data tables with a rows per page selector.

<ComponentPreview styleName="base-weibo" name="pagination-icons-only" />
