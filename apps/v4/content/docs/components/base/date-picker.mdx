...
<ComponentPreview styleName="base-weibo" name="date-picker-demo" />
...
<ComponentPreview styleName="base-weibo" name="date-picker-basic" />

### Range Picker

A date picker component for selecting a range of dates.

<ComponentPreview styleName="base-weibo" name="date-picker-range" />
...
<ComponentPreview styleName="base-weibo" name="date-picker-dob" />

### Input

A date picker component with an input field for selecting a date.

<ComponentPreview styleName="base-weibo" name="date-picker-input" />

### Time Picker

A date picker component with a time input field for selecting a time.

<ComponentPreview styleName="base-weibo" name="date-picker-time" />

### Natural Language Picker

This component uses the `chrono-node` library to parse natural language dates.

<ComponentPreview styleName="base-weibo" name="date-picker-natural-language" />
