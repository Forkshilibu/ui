...
<ComponentPreview styleName="base-weibo" name="tabs-line" />

### Vertical

Use `orientation="vertical"` for vertical tabs.

<ComponentPreview styleName="base-weibo" name="tabs-vertical" />

### Disabled

<ComponentPreview styleName="base-weibo" name="tabs-disabled" />

### Icons

<ComponentPreview styleName="base-weibo" name="tabs-icons" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-weibo" name="tabs-rtl" direction="rtl" />
