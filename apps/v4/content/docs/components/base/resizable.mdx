...
<ComponentPreview styleName="base-weibo" name="resizable-vertical" />

### Handle

Use the `withHandle` prop on `ResizableHandle` to show a visible handle.

<ComponentPreview styleName="base-weibo" name="resizable-handle" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-weibo" name="resizable-rtl" direction="rtl" />
