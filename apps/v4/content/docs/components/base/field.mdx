...
<ComponentPreview styleName="base-weibo" name="field-input" />

### Textarea

<ComponentPreview styleName="base-weibo" name="field-textarea" />

### Select

<ComponentPreview styleName="base-weibo" name="field-select" />

### Slider

<ComponentPreview styleName="base-weibo" name="field-slider" />

### Fieldset

<ComponentPreview styleName="base-weibo" name="field-fieldset" />
...
<ComponentPreview styleName="base-weibo" name="field-radio" />

### Switch

<ComponentPreview styleName="base-weibo" name="field-switch" />

### Choice Card

Wrap `Field` components inside `FieldLabel` to create selectable field groups. This works with `RadioItem`, `Checkbox` and `Switch` components.

<ComponentPreview styleName="base-weibo" name="field-choice-card" />
