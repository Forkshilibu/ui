...
<ComponentPreview styleName="base-weibo" name="menubar-demo" />
...
<ComponentPreview styleName="base-weibo" name="menubar-checkbox" />

### Radio

Use `MenubarRadioGroup` and `MenubarRadioItem` for single-select options.

<ComponentPreview styleName="base-weibo" name="menubar-radio" />

### Submenu

Use `MenubarSub`, `MenubarSubTrigger`, and `MenubarSubContent` for nested menus.

<ComponentPreview styleName="base-weibo" name="menubar-submenu" />

### With Icons

<ComponentPreview styleName="base-weibo" name="menubar-icons" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-weibo" name="menubar-rtl" direction="rtl" />
